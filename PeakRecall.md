...
In our case, we just have normalized ATAC-seq signal tracks in BedGraph and thus cannot extend reads, the average signal 
...
# result
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjI3OTk2ODE1LDExNzc0Njc5NjksMTE3Mz
