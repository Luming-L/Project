...
In step 6, the ATAC-seq signal at each genomic location stored in BedGraph will be tested against the lambda  with Poisson distribution. The score in the output file is -log10(p-value)s or -log10(q-value)s (according to option `-m`) for each location.
```bash
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMTk3NjUyODUsLTE3ODk4ODE3NjEsMT
Y1OTI5ODI0NywtMTE3MDExOTgxOSwtNTc3NzQ0Mzg2LC00Njk5
NjgwMTksLTE0NTg5NzI1MjEsMTE3NzQ2Nzk2OSwxMTczNDc4Ni
w5OTMwNzIwNjAsMTg2NjAyNTY3NCwtMTMxNDQyMzc0MSwtMTk4
MTAzNTYxLC01NDczMTIyNDMsLTE5Mzk1NjkzNDcsMzc5MzczMz
MxLC02OTU1MjU1NCw3NDY3NzUyNTEsLTE5OTc3NTMyMTcsLTI3
MTQ5MDAyM119
-->