...
In our case, we just have normalized ATAC-seq signal tracks in BedGraph and thus cannot extend reads, genome  will be the 
...
# result
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjcxMTkyOTQ2LDExNzc0Njc5NjksMTE3Mz
