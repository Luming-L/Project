...
**another thing:** The score in BedGraph for peak calling is signal in each 100-bp bin, so the local lambda should be average signal on 100-bp level
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDY2MzIzMjMsMjg4NjEyNDY3LDIwOD
