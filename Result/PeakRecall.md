...
**another thing:** The score in BedGraph for peak calling is signal in each 100-bp bin, so we need a local lambda 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTEwNzg5MDEsMjg4NjEyNDY3LDIwOD
